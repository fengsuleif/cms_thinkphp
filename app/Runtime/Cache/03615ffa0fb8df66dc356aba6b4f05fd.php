...
<div class="span8">
 ...
 <div class="hero-unit">
  ...
  <ul class="unstyled ">   
		 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li ><a href="/app/index.php/Index/showview/<?php echo ($vo["cid"]); ?>/<?php echo ($vo["id"]); ?>" data=""><?php echo ($vo["id"]); ?>  <?php echo ($vo["title"]); ?> </a> <p><small></small></p></li><?php endforeach; endif; else: echo "" ;endif; ?>
